...
## 1. FHFA Housing Price Index (county level data) — `hpi_at_county.xlsx`
...
- Place in `data/raw/` after downloading the state market tracker file (note: rename to `real_estate_sales.csv` for cleaning)
